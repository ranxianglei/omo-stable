# Omo-Stable Orchestration Guide
...
This document provides a comprehensive guide to the orchestration system that implements Omo-Stable's core philosophy: **"Separation of Planning and Execution"**.
...
Omo-Stable solves this by clearly separating two roles:
...
You can control related features in `omo-stable.json`.
